...
export default function Page() {
  ...
  useEffect(()=>{
    setTimeout(() => {setfload(false)}, 100);
  },[])
  
    onAuthStateChanged(auth, (user) => {
      if (!user) {
        sessionStorage.setItem("type", "redirect");
  ...
  return (
    ...
    <div id='data' className="min-h-screen hidden pt-14 flex-col max-w-[800px] mx-auto w-full">
    ...
    /> */}
          ...
          <h1 className="text-lg text-gray-400">Please Fill this form for an Enquiry</h1>
        </div>
