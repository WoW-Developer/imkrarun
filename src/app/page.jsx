  ...
  return (
    <div className=" w-full  h-screen max-w-[810px] p-5 mx-auto">
      ...
      <h1 className="text-black dark:text-white whitespace-pre-wrap select-none text-xl p-2 mt-28">
        ...
        subject?{"\n"}
        {"\n"}If so, I am here to help! I am a highly experienced and qualified
        mathematics tutor with a passion for helping students achieve their full
        potential. I have a deep understanding of mathematical concepts and am
        able to explain them in a clear and concise manner, making it easy for
        students to understand and retain the information.{"\n"}
        {"\n"}I also believe in creating a positive and supportive learning
        environment that encourages students to ask questions and engage with
        the material. My approach to tutoring is tailored to meet the needs of
        each individual student.{"\n"}
        {"\n"}I start by conducting a thorough assessment of the student&#039;s
        current knowledge and skills, and then create a customized learning plan
        that is designed to help them achieve their goals. Whether you or your
        child is struggling with a specific math topic, preparing for an exam,
        or just looking to improve their overall understanding and confidence, I
        am here to help.{"\n"}
