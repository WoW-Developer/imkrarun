...
export default function Home() {
  return (
    <div className=" w-full  h-screen max-w-[810px] p-5 mx-auto">
      ...
      <h1 className="text-white select-none text-xl p-2 mt-28">
        ...
        tailored to meet the needs of each individual student. I start by
        ...
        to help. So why wait? If you&#039;re ready to take the next step in
